...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'propertytime_ipmfront', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_8fd9f3d3b8bf7fee5ad6e63994bc7949');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_8fd9f3d3b8bf7fee5ad6e63994bc7949');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_8fd9f3d3b8bf7fee5ad6e63994bc7949');
        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Nuada/ApiBundle/Entity'))), 'Nuada\\ApiBundle\\Entity');
        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('NuadaApiBundle' => 'Nuada\\ApiBundle\\Entity'));
    ...
    {
        return $this->services['fos_rest.format_listener'] = new \FOS\RestBundle\EventListener\FormatListener($this->get('fos_rest.format_negotiator'), 'json', array(0 => 'json', 1 => 'pdf', 2 => 'html'), true);
    }
    ...
    {
        return $this->services['fos_rest.routing.loader.reader.action'] = new \FOS\RestBundle\Routing\Loader\Reader\RestActionReader($this->get('annotation_reader'), $this->get('fos_rest.request.param_fetcher.reader'), $this->get('fos_rest.inflector.doctrine'), true, array('json' => false, 'pdf' => false, 'html' => true));
    }
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d H:i:s', 'UTC');
    }
    ...
    {
        return $this->services['nuada_api.listing_manager'] = new \Nuada\ApiBundle\Manager\ListingManager($this->get('doctrine'), $this->get('security.context'), $this->get('validator'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Nuada/ApiBundle/Resources/views'), 'NuadaApi');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'NuadaApiBundle' => 'Nuada\\ApiBundle\\NuadaApiBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'propertytime_ipmfront',
            'database_user' => 'root',
